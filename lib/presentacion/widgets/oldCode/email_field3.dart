...
class EmailField3 extends StatefulWidget {
  ...
  @override
  State<EmailField3> createState() => _EmailField3State();
}

class _EmailField3State extends State<EmailField3>
  ...
  void initState() {
    ...
    final tween = ColorTween(begin: Colors.grey.withOpacity(0), end: Colors.blue.shade300);
        ...
        TweenAnimationBuilder<double>(
          ...
          builder: ((_, value, __) => Opacity(
                ...
                child: TextFormField(
                  ...
                  focusNode: node,
                  decoration:
                      const InputDecoration(hintText: "Segundo Nombre"),
